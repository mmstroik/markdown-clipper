...
- **Parser Engine**: Choose between 'Readability' (default) and 'Defuddle'. Readability aims for minimal clutter. Defuddle removes fewer uncertain elements and can extract more metadata.
